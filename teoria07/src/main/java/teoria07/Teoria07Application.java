...
public class App implements CommandLineRunner {
	...
	public void ler() {
		...
		long id = Long.parseLong(entrada.nextLine());
		out.println(titularRepo.getNome() + titularRepo.getCpf() + titularRepo.getId());
	} 

	public void alterar() {
		out.println("Qual o ID do titular: ");
		long id = Long.parseLong(entrada.nextLine());
		titularRepo.update(id);
		out.println("Qual o cpf do titular: ");
		String cpf = entrada.nextLine();
		titularRepo.update(cpf);
		out.println(titularRepo.getId() + " " + titularRepo.getCpf());
	}
